...
namespace Control
{
    public class Ctrl_Archer_AI : BaseControl
    {
        ...
        public float cordonDistance = 20f;
        ...
        void Start()
        {
            ...
            /* 确定个体差异性参数  */
            moveSpeed = UnityHelper.GetInstance().GetRandomNumByRange(1, 3);
            attackDistance = UnityHelper.GetInstance().GetRandomNumByRange(11, 15);
            cordonDistance = UnityHelper.GetInstance().GetRandomNumByRange(16, 25);
