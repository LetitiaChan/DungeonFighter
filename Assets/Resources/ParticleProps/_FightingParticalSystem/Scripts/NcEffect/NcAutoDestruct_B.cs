...
public class NcAutoDestruct_ : NcEffectBehaviour_
{
    // Attribute ------------------------------------------------------------------------
    ...
    protected NcCurveAnimation_ m_NcCurveAnimation;

    // Create ---------------------------------------------------------------------------
    public static NcAutoDestruct_ CreateAutoDestruct(GameObject baseGameObject, float fLifeTime, float fDestroyTime, bool bSmoothHide)
    {
        NcAutoDestruct_ ncAutoDestruct = baseGameObject.AddComponent<NcAutoDestruct_>();
    ...
    void Start()
    {
        ...
        if (m_bEndNcCurveAnimation)
            m_NcCurveAnimation = GetComponent<NcCurveAnimation_>();
    }
