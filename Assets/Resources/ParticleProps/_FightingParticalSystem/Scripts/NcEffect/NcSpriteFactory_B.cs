...
public class NcSpriteFactory_ : NcEffectBehaviour_
{
    // class ------------------------------------------------------------------------
    [System.Serializable]
    ...
    public NcAttachSound_ m_CurrentSound;
    ...
    // Control Function -----------------------------------------------------------------
    public NcEffectBehaviour_ SetSprite(int nNodeIndex)
    {
        return SetSprite(nNodeIndex, true);
    }

    public NcEffectBehaviour_ SetSprite(int nNodeIndex, bool bRunImmediate)
    {
        ...
        NcSpriteAnimation_ spriteCom = GetComponent<NcSpriteAnimation_>();
        if (spriteCom != null)
        {
        ...
        NcSpriteTexture_ uvCom = GetComponent<NcSpriteTexture_>();
        if (uvCom != null)
        {
    ...
    public GameObject CreateSpriteEffect(int nSrcSpriteIndex, Transform parentTrans)
    {
        ...
        if (m_SpriteList[nSrcSpriteIndex].m_EffectPrefab != null)
        {
            ...
            NcAttachPrefab_ attachCom = createEffect.AddComponent<NcAttachPrefab_>();
    ...
    void CreateSoundObject(NcSpriteNode ncSpriteNode)
    {
        ...
        if (ncSpriteNode.m_AudioClip != null)
        {
            if (m_CurrentSound == null)
                m_CurrentSound = gameObject.AddComponent<NcAttachSound_>();
    ...
    // 첫 frame 시작할때...
    public void OnAnimationStartFrame(NcSpriteAnimation_ spriteCom)
    {
    }

    // frame 변경될 때 마다... (frame skip 되기도 함)
    public void OnAnimationChangingFrame(NcSpriteAnimation_ spriteCom, int nOldIndex, int nNewIndex, int nLoopCount)
    {
    ...
    public bool OnAnimationLastFrame(NcSpriteAnimation_ spriteCom, int nLoopCount)
    {
        if (m_SpriteList.Count <= m_nCurrentIndex)
            return false;
        ...
        {
            NcSpriteAnimation_ ncTarSprite = SetSprite(m_SpriteList[m_nCurrentIndex].m_nNextSpriteIndex) as NcSpriteAnimation_;
            if (ncTarSprite != null)
            {
