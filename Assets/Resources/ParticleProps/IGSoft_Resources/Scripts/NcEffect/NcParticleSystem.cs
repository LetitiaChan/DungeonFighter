...
public class NcParticleSystem_ : NcEffectBehaviour_
{
    // Attribute ------------------------------------------------------------------------
    ...
    void CreateAttachPrefab(Vector3 position, float size)
    {
        ...
        {
            NcAutoDestruct_ ncAd = createGameObject.GetComponent<NcAutoDestruct_>();
            if (ncAd == null)
                ncAd = createGameObject.AddComponent<NcAutoDestruct_>();
